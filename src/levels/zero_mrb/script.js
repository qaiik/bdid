...
const initEnvironment = () => {
  ...
  const wall2 = new THREE.Mesh(new THREE.BoxGeometry(0.5, 2, 30.5), new THREE.MeshStandardMaterial({
    color: "red"
  }));
  wall2.position.y = 0;
  wall2.position.x = -14;
  ...
  const wall3 = new THREE.Mesh(new THREE.BoxGeometry(28, 2, 0.5), new THREE.MeshStandardMaterial({
    color: "red"
  }));
  wall3.position.y = 0;
  wall3.position.z = 15;
  ...
  const wall4 = new THREE.Mesh(new THREE.BoxGeometry(28, 2, 0.5), new THREE.MeshStandardMaterial({
    color: "red"
  }));
  wall4.position.y = 0;
  wall4.position.z = -15;
...
const init = () => {
  ...
  renderer.setPixelRatio(window.devicePixelRatio /* (graphicsPercent / 100)*/ );
...
const characterMovement = () => {
  ...
  if (mouse.y) {
    ...
    // Camera.quaternion.copy(fpc.rotation_,
